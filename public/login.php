...
<body class="bg-expensio min-h-screen flex items-center justify-center py-10 relative overflow-x-hidden font-sans">
    ...
    <div class="auth-card w-full max-w-[400px] p-6 rounded-[28px] z-10 mx-6 animate-[fadeIn_0.5s_ease-out]">
        ...
        <div class="text-center mb-4 relative z-10">
            ...
            <h1 class="text-xl font-bold text-gray-900 mb-1 tracking-tight">Sign in with email</h1>
        </div>

        <!-- Login Form -->
        <form action="../app/Controllers/AuthController.php?action=login" method="POST" class="space-y-3">
            <!-- Email Field -->
            ...
            <div class="space-y-1.5">
                ...
                <div class="text-right">
                    <a href="forgot-password.php" class="text-[11px] font-medium text-gray-500 hover:text-[#7C3AED] transition-colors">Forgot password?</a>
                </div>
            </div>
        ...
        <div class="relative my-4">
            ...
            <div class="relative flex justify-center text-[11px]">
                <span class="bg-white/0 px-3 text-gray-400 italic">Or sign in with</span>
            </div>
        </div>

        <!-- Social Login -->
        <div class="grid grid-cols-3 gap-3">
            <a href="google-callback.php" class="flex items-center justify-center p-2 rounded-xl auth-button hover:bg-gray-50 transition-all group">
                <i class='bx bxl-google text-2xl text-red-500 group-hover:scale-110 transition-transform'></i>
            </a>
            <button type="button" class="flex items-center justify-center p-2 rounded-xl auth-button hover:bg-gray-50 transition-all group">
        ...
        <div class="text-center mt-6">
            <p class="text-[12px] text-gray-500">
                Don't have an account? <a href="signup.php" class="font-bold text-expensio-dark hover:underline">Sign up</a>
            </p>
        </div>
    </div>
