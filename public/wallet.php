            ...
            <form action="../app/Controllers/ExpenseController.php?action=create" method="POST" class="space-y-4">
                ...
                <div class="space-y-1.5 mt-2">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_recurring" value="1" class="w-4 h-4 text-expensio-purple bg-gray-100 border-gray-300 rounded focus:ring-expensio-purple" onchange="document.getElementById('recurringOptionsExp').classList.toggle('hidden', !this.checked)">
                        <span class="text-[11px] font-black uppercase text-gray-600">Repeat this transaction?</span>
                    </label>
                </div>
                <div id="recurringOptionsExp" class="space-y-1.5 hidden mt-2">
    ...
    <div id="addIncomeModal" class="fixed inset-0 bg-expensio-dark/60 backdrop-blur-sm z-[100] hidden flex items-center justify-center p-6 transition-all">
        <div class="glass-card w-full max-w-lg p-8 rounded-[32px] shadow-2xl animate-[fadeIn_0.5s_ease-out] relative bg-white/80">
            ...
            <form action="../app/Controllers/ExpenseController.php?action=create" method="POST" class="space-y-4">
                ...
                <div class="space-y-1.5 mt-2">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_recurring" value="1" class="w-4 h-4 text-green-500 bg-gray-100 border-gray-300 rounded focus:ring-green-500" onchange="document.getElementById('recurringOptionsInc').classList.toggle('hidden', !this.checked)">
                        <span class="text-[11px] font-black uppercase text-gray-600">Repeat this transaction?</span>
                    </label>
                </div>
                <div id="recurringOptionsInc" class="space-y-1.5 hidden mt-2">
                    <label class="text-[10px] font-black uppercase text-gray-400 ml-1">Frequency</label>
                    <select name="frequency" class="w-full px-4 py-3 bg-white/50 border border-white rounded-2xl outline-none focus:bg-white transition-all text-sm font-medium">
                        <option value="daily">Daily</option>
                        <option value="weekly">Weekly</option>
