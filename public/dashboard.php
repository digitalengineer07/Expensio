...
<body class="bg-expensio h-[100dvh] w-full flex font-sans overflow-hidden m-0 p-0">
    ...
    <main class="flex-1 h-[100dvh] overflow-y-auto custom-scrollbar relative pb-24 md:pb-0">
        ...
        $page_subtitle = 'Welcome back, <span class="font-semibold text-expensio-purple">' . htmlspecialchars($username) . '</span>';
        ...
        <div class="px-6 pt-8 flex justify-between items-center mb-6 animate-fade">
            ...
            <div class="flex items-center gap-3 w-full justify-end sm:w-auto">
                <button onclick="toggleModal('addExpenseModal')" class="flex flex-row items-center gap-2 bg-expensio-purple text-white px-6 py-2.5 rounded-full font-semibold hover:opacity-90 transition-all text-[14px]">
                    <i class='bx bx-plus text-lg'></i>
                    <span>Add Expense</span>
                </button>
                <button onclick="alert('Manage widgets coming soon!');" class="hidden md:flex items-center gap-2 border border-expensio-purple text-expensio-purple rounded-full px-5 py-2.5 bg-white text-[14px] font-semibold hover:bg-gray-50 transition-all">
